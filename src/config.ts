...
export const UNIT_TO_TANK_ID: number[] = [
  ...
  102,  // 유닛보드 3
  103,  // 유닛보드 4
  104, 105, 106, 107, 108, 109, 110, 201, 202, 203, 301, 501,  // 유닛보드 5~16 (12→201, 13→202, 14→203, 15→301, 16→501)
  502, 503, 118, 119, 120, 121, 122, 123, 124, 125, 126, 127, 128, 129, 130, 131  // 유닛보드 17→502, 18→503, 19~32
];
